...
Hud::Hud():HUD_WIDTH(300),HUD_HEIGHT(200),startX(0),startY(0){}

int Hud::getstartX()const{return startX;}
int Hud::getstartY()const{return startY;}
int Hud::getHUD_WIDTH()const{return HUD_WIDTH; }
int Hud::getHUD_HEIGHT()const{return HUD_HEIGHT;}
...
void Hud::Draw_Pixel(SDL_Surface* s, int x, int y, 
...
void Hud::Draw_AALine(SDL_Surface* screen, float x0, float y0, 
...
void Hud::Draw_AALine(SDL_Surface* screen, float x0, float y0, float x1, float y1, float thick, uint32_t color)const{
	Uint8 r, g, b;
	SDL_GetRGB(color, screen->format, &r, &g, &b);
	Draw_AALine(screen, x0+0.5f, y0+0.5f, x1+0.5f, y1+0.5f, thick, r, g, b, 0xFF);
}

void Hud::Draw_AALine(SDL_Surface* screen, float x0, float y0, float x1, float y1, uint32_t color)const{
	Uint8 r, g, b;
	SDL_GetRGB(color, screen->format, &r, &g, &b);
